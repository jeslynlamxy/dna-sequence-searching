...
def test_fixed_query():
    ...
    csv_columns = ["Genome Size", "BF Time", "BM Time", "RK Time", "KMP Time"]
    csv_data = []
    ...
    for value in range(10, x):
        ...
        # append data
        csv_data.append([value, bf_time_taken, bm_time_taken, rk_time_taken, kmp_time_taken])
    csv_dataframe = pd.DataFrame(csv_data, columns=csv_columns)
